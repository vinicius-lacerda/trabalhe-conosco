<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Contato.aspx.cs" Inherits="CaoFuncional.Pages.FaleConosco.Contato" %>
...
<body>
    ...
    <div class="row" style="background: #ccc;">
        <picture>
	        <source media="(max-width: 480px)" srcset="../../Assets/Images/Backgrounds/FaleConosco/Contato-480.jpg" />
	        <source media="(max-width: 768px)" srcset="../../Assets/Images/Backgrounds/FaleConosco/Contato-768.jpg" />
	        <img src="../../Assets/Images/Backgrounds/FaleConosco/Contato-1366.jpg" style="width:auto; float: right;" />
        </picture>
    </div>
        ...
        <div class="row" style="margin-top:50px; margin-bottom:50px;">
            ...
            <i style="font-size:13px; float:right; color:#ff0000; margin-top:-50px;">Os campos com (*) são obrigatórios.</i>
            </div>
            <div class="col-md-12" style="margin-bottom:10px;">
                <asp:Label ID="lblMsgError" runat="server" Text=""></asp:Label><br />
            </div>
            <div class="col-md-6">
                <asp:TextBox ID="txtNomeEmpresa" runat="server" CssClass="form-control" PlaceHolder="Nome ou Empresa"></asp:TextBox>               
                <asp:TextBox ID="txtTelefone" runat="server" CssClass="form-control form-contact" PlaceHolder="Celular (xx) xxxxx-xxxx"></asp:TextBox>
                <asp:TextBox ID="txtFixo" runat="server" CssClass="form-control form-contact" PlaceHolder="Fixo (xx) xxxx-xxxx"></asp:TextBox>
                <asp:TextBox ID="txtEmail" runat="server" CssClass="form-control form-contact" PlaceHolder="Email"></asp:TextBox>
                <asp:DropDownList ID="ddlAssunto" runat="server" CssClass="form-control">
                    ...
                    <asp:ListItem>Elogios</asp:ListItem>
                    <asp:ListItem>Sugestões</asp:ListItem>
                    <asp:ListItem>Reclamações</asp:ListItem>
                    <asp:ListItem>Outros</asp:ListItem>
                </asp:DropDownList>
                <textarea name="txtMensagem" runat="server" id="txtMensagem" cols="30" rows="10" PlaceHolder="Mensagem" CssClass="form-control form-contact" style="width:100%; margin-top:10px; margin-bottom:10px; border-radius: 5px;"></textarea>
            ...
            <div class="col-md-6">
                <div class="map-wrap">
                    ...
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3943.280143529624!2d-63.86371578551622!3d-8.759691293707968!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x92325b6ad6825b2b%3A0x2ac27430d7589a4e!2sFortal%20Superatacado!5e0!3m2!1spt-BR!2sbr!4v1598041027201!5m2!1spt-BR!2sbr" class="gmaps" width="700" height="auto" frameborder="0" style="border:0" allowfullscreen></iframe>          
                </div>
            </div>
        </div>
