<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CREnviado.aspx.cs" Inherits="CaoFuncional.Pages.TrabalheConosco.CREnviado" %>
    ...
    <%--<div class="row" style="background: #ccc;">
        ...
        <div class="row" style="">
            <div class="col-md-12" style="margin:0; padding:0;">
                ...
                <asp:Button ID="btnHomePage" runat="server" Text="Voltar para a Página Inicial" CssClass="form-control btnHomePage" OnClick="btnHomePage_Click" />

                <img src="../../Assets/Images/background-crenviado.jpg" style="width:100%; height:auto;"/>
            </div>
        </div>
