            ...
            if(fupPDF.HasFile) // Verifica se recebe vazio
            {
                ...
                else
                {
                    ...
                    else
                    {
                            ...
                            string nomeRemetente = txtNome.Text + txtSobrenome;
                            ...
                            string conteudoMensagem = "Nome: " + txtNome.Text + Environment.NewLine
                                                      + "Email: " + txtEmail.Text + Environment.NewLine
                                                      + "Assunto: " + ddlAssunto.SelectedValue + Environment.NewLine
