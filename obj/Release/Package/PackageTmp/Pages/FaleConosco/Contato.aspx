...
<%--          <li class="nav-item">
          ...
          <li class="nav-item dropdown active">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
              <a class="dropdown-item active" href="/Pages/FaleConosco/Contato.aspx">Contato</a>
    ...
    <div class="row" style="background: #ccc;">
        ...
        <div class="row" style="margin-top:50px; margin-bottom:50px;">
            <div class="col-md-6">
                ...
                <textarea name="txtMensagem" id="txtMensagem" cols="30" rows="10" PlaceHolder="Mensagem" CssClass="form-control form-contact" style="width:100%; margin-top:10px; margin-bottom:10px; border-radius: 5px;"></textarea>
                <asp:Button ID="btnEnviar" runat="server" Text="Enviar" CssClass="btn-primary" />
            </div>
            <div class="col-md-6">
                <div class="map-wrap">
