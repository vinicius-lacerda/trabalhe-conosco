<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Promocoes.aspx.cs" Inherits="CaoFuncional.Pages.Promocoes.Promocoes" %>
...
<%--          <li class="nav-item">
    ...
    <div class="row" style="background: #ccc;">
        <picture>
	        <source media="(max-width: 480px)" srcset="../../Assets/Images/Backgrounds/Promocoes/Promocoes-480.jpg" />
	        <source media="(max-width: 768px)" srcset="../../Assets/Images/Backgrounds/Promocoes/Promocoes-768.jpg" />
	        <img src="../../Assets/Images/Backgrounds/Promocoes/Promocoes-1366.jpg" style="width:auto; float: right;" />
        </picture>
    </div>
          ...
          <div class="row">
            <div class="col-3">
              <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                <a class="nav-link active" id="v-pills-home-tab" data-toggle="pill" href="#v-pills-home" role="tab" aria-controls="v-pills-home" aria-selected="true">Fornecedor 1</a>
                <a class="nav-link" id="v-pills-profile-tab" data-toggle="pill" href="#v-pills-profile" role="tab" aria-controls="v-pills-profile" aria-selected="false">Fornecedor 2</a>
                <a class="nav-link" id="v-pills-messages-tab" data-toggle="pill" href="#v-pills-messages" role="tab" aria-controls="v-pills-messages" aria-selected="false">Fornecedor 3</a>
                <a class="nav-link" id="v-pills-settings-tab" data-toggle="pill" href="#v-pills-settings" role="tab" aria-controls="v-pills-settings" aria-selected="false">Fornecedor 4</a>
              </div>
            </div>
            <div class="col-9">
